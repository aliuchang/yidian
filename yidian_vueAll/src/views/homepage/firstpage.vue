...
export default {
  ...
  data() {
    return {
      ...
      chairdata:{brand:"HENRIKSDAL 亨利克",name:"椅子、桦木、格雷伯 白色",info:"愉快地享用完漫长的餐点后，如果桌布椅套可以清洗，那可真是美事一桩。HENRIKSDAL 亨利克 可能是我们最舒适的椅子了！",money:"459.00"},
      imagesbox: [
...
.day-box {
  ...
  .day-box .el-carousel .el-carousel__container {
    background: #fff;
  }
  .today-box {
    width: 215px;
